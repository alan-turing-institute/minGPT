...
if ddp:
    ...
    print("RANK: {ddp_rank}")
    print("LOCAL_RANK: {ddp_local_rank}")
...
B = 64
T = 1024
assert total_batch_size % (B * T * ddp_world_size) == 0, "make sure total_batch size is divisible by B * T * ddp_world_size"
